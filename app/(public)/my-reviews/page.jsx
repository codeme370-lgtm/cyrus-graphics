...
export const metadata = {
  title: 'My Reviews - Cyrus Graphics',
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-slate-100 px-6 py-10">
      <div className="mx-auto max-w-6xl rounded-[32px] border border-slate-800 bg-slate-900/90 p-10 shadow-[0_40px_120px_-40px_rgba(15,23,42,0.9)]">
        <h1 className="text-4xl font-semibold text-white">My Reviews</h1>
        <p className="mt-4 text-slate-400">Review your past ratings and feedback for purchased items.</p>
        <div className="mt-8">
